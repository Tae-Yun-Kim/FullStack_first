...
const EtcFoodRecipes = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const filteredMealkits = data.filter((mealkit) => mealkit.category === "ETC");
  ...
  return (
    <div className="container mx-auto p-8 max-w-screen-lg bg-white shadow-lg rounded-lg">
      <h1 className="text-3xl font-bold mb-6">기타</h1>
